...
def upgrade() -> None:
    ...
    sa.Column('home_away', sa.Enum('HOME', 'AWAY', name='gamelocation'), nullable=False),
    ...
    sa.Column('stats_type', sa.Enum('PLAYER', 'GAME', name='statstype'), nullable=False),
...
def downgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['assignee'], ['user.user_id'], name='task_assignee_fkey'),
    sa.ForeignKeyConstraint(['project'], ['project.project_id'], name='task_project_fkey'),
